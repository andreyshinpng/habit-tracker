        ...
        <header>
            <div class="controls">
                ...
                <div class="controls-right">
                    <button id="settingsBtn" class="button button-with-icon">
